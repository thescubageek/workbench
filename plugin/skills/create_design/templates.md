# create_design — output template

Read this when Step 5 directs you to. Write `design.md` in this shape. Never paraphrase the
template from memory; every bracketed placeholder must be replaced before the file is written.
